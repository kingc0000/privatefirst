...
public class SystemConfigurationControllerTest extends AbstractController {
	@Autowired
	...
	public void test1() throws Exception {
		ResultActions ra = mockMvc
				.perform(MockMvcRequestBuilders.get("/admin/configuration/system.html")
	...
	public void test2() throws Exception {
		ResultActions ra = mockMvc
				.perform(MockMvcRequestBuilders.get("/admin/configuration/saveSystemConfiguration.html")
						.with(SecurityRequestPostProcessors.userDeatilsService("admin")))
