package com.kekeinfo.web.admin.controller.reports;
...
public class ReportsControllerTest extends AbstractController {
	@Autowired
	...
	public void test1() throws Exception {
		ResultActions ra = mockMvc.perform(MockMvcRequestBuilders.get("/admin/reports/productsales.html")
	...
	public void test2() throws Exception {
		ResultActions ra = mockMvc.perform(MockMvcRequestBuilders.get("/admin/reports/server_processing.shtml")
