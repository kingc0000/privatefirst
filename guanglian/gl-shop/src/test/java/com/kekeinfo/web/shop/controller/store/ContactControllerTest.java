package com.kekeinfo.web.shop.controller.store;
...
public class ContactControllerTest extends AbstractController {
	@Autowired
	...
	public void test1() throws Exception {
		ResultActions ra = mockMvc
				.perform(MockMvcRequestBuilders.get("/shop/store/contactus.html")
						.with(SecurityRequestPostProcessors.userDeatilsService("test")))
				.andExpect(MockMvcResultMatchers.model().attributeExists("content"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("aboutus"));
	...
	public void test21() throws Exception {
		ResultActions ra = mockMvc.perform(MockMvcRequestBuilders.get("/shop/store/contactus.html"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("content"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("aboutus"));
		ra.andDo(MockMvcResultHandlers.print());
		MvcResult mr = ra.andReturn();
	...
	public void test2() throws Exception {
		ResultActions ra = mockMvc.perform(MockMvcRequestBuilders.get("/shop/store/{storeCode}/contact")
