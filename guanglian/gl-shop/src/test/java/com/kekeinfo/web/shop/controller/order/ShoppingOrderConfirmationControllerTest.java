...
public class ShoppingOrderConfirmationControllerTest extends AbstractController {
	@Autowired
	...
	public void test1() throws Exception {
		ResultActions ra = mockMvc
				.perform(MockMvcRequestBuilders.get("/shop/order/confirmation.html")
						.with(SecurityRequestPostProcessors.userDeatilsService("test")))
				.andExpect(MockMvcResultMatchers.model().attributeExists("confirmation"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("ordermessage"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("orderemail"))
	...
	public void test21() throws Exception {
		ResultActions ra = mockMvc.perform(MockMvcRequestBuilders.get("/shop/order/confirmation.html"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("confirmation"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("ordermessage"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("orderemail"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("order"));
