...
public class GroupsControllerTest extends AbstractController {
	@Autowired
	...
	public void test1() throws Exception {
		ResultActions ra = mockMvc
				.perform(MockMvcRequestBuilders.get("/admin/groups/editGroup.html")
	...
	public void test2() throws Exception {
		ResultActions ra = mockMvc
				.perform(MockMvcRequestBuilders.get("/admin/groups/groups.html")
						.with(SecurityRequestPostProcessors.userDeatilsService("admin")))
	...
	public void test3() throws Exception {
		ResultActions ra = mockMvc.perform(MockMvcRequestBuilders.get("/admin/groups/paging.html")
