package com.kekeinfo.web.shop.controller.content;
...
public class ShopContentControllerTest extends AbstractController {
	@Autowired
	...
	public void test1() throws Exception {
		ResultActions ra = mockMvc
				.perform(MockMvcRequestBuilders.get("/shop/pages/{friendlyUrl}.html")
	...
	public void test21() throws Exception {
		ResultActions ra = mockMvc.perform(MockMvcRequestBuilders.get("/shop/pages/{friendlyUrl}.html"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("content"));
		ra.andDo(MockMvcResultHandlers.print());
		MvcResult mr = ra.andReturn();
		System.out.println(">>>>>testListContentPagesByAuth>>>>>" + mr.getResponse().getContentAsString());
