				...
				$.fn.revolution.defaults = {
					...
					return this.each(function() {
						...
						if (!container.hasClass("revslider-initialised")) {
									...
									if($(window).width()>767){
										$(".fullwidthabnner").height(window.innerHeight/1.45);
										//$(".fullwidthabnner").css("max-height",window.innerHeight/1.45+" !important;");
									}else{
										$(".fullwidthabnner").css("max-height","500px !important;");
									}
