      ...
      <div class="modal-dialog mag-dialog" >
        <div class="modal-content" >
        	<div class="modal-header">
              ...
              <h4 class="modal-title" id="etitle">斜测导入</h4>
            </div>
                                  ...
                                  <div id="wizard">
                                      ...
                                      <section>
										<div class="alert alert-block alert-danger fade in">
                                          ...
                                          <div class="form-group clearfix" >
                                              <label class="col-lg-2 control-label control-required" >深度</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select required"></select>
                                              </div>
                                              <label class="col-lg-2 control-label monitorpoint" >初始值</label>
                                              <div class="col-lg-4 monitorpoint" >
                                                  <select class="form-control select monitorpoint"></select>
                                              </div>
                                              <label class="col-lg-2 control-label monitordata control-required" >本次值</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select monitordata required"></select>
                                              </div>
                                          </div> 
                                          <div class="form-group clearfix monitordata" >
                                              <label class="col-lg-2 control-label " >测量时间</label>
                                              <div class="col-lg-10">
