										...
										<div class="alert alert-block alert-danger fade in">
                                          ...
                                          <div class="form-group clearfix" >
                                              ...
                                              <div class="col-lg-4">
                                               ...
                                               <label class="col-lg-2 control-label control-required" >水温告警阈值</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select required"></select>
                                              </div>
                                          </div>
                                          <div class="form-group clearfix" >
                                              <label class="col-lg-2 control-label control-required" >水位计量告警阈值上限</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select required"></select>
                                              </div>
                                               <label class="col-lg-2 control-label control-required" >水位计量告警阈值下限</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select required"></select>
                                              </div>
                                          </div>
                                          <div class="form-group clearfix" >
                                              <label class="col-lg-2 control-label" >测点GPRS号码</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select"></select>
                                              </div>
                                               <label class="col-lg-2 control-label" >大气压参考点</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select"></select>
                                              </div>
                                          </div>
                                          <div class="form-group clearfix" >
                                              <label class="col-lg-2 control-label" >孔标高</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select"></select>
                                              </div>
                                               <label class="col-lg-2 control-label" >地面标高</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select"></select>
                                              </div>
                                          </div>
                                          <div class="form-group clearfix" >
                                             <label class="col-lg-2 control-label" >孔深</label>
                                             <div class="col-lg-4">
                                                 <select class="form-control select"></select>
                                             </div>
                                              <label class="col-lg-2 control-label" >入井线长</label>
                                             <div class="col-lg-4">
                                                 <select class="form-control select"></select>
                                             </div>
                                          </div>
                                          <div class="form-group clearfix" >
                                              <label class="col-lg-2 control-label " >监控间隔时间(单位秒)</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select"></select>
                                              </div>
                                          ...
                                          <div class="form-group clearfix" >
                                              ...
                                              <div class="col-lg-4">
                                               ...
                                               <label class="col-lg-2 control-label" >降水目的层(逗号分隔)</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select "></select>
                                              </div>
                                          </div>
                                          <jsp:include page="/pages/water/import/importbasewell.jsp" />
                                      </section>
                                      <h3>确认导入</h3>
                                      <section>
                                          <div class="form-group clearfix">
