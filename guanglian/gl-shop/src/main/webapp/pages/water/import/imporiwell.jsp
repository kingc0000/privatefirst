										...
										<div class="alert alert-block alert-danger fade in">
                                          ...
                                          <div class="form-group clearfix" >
                                              ...
                                              <div class="col-lg-4">
                                               ...
                                               <label class="col-lg-2 control-label control-required" >流量告警阈值</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select required"></select>
                                              </div>
                                          </div>
                                          <div class="form-group clearfix" >
                                              <label class="col-lg-2 control-label control-required" >回灌井内水位告警阈值</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select required"></select>
                                              </div>
