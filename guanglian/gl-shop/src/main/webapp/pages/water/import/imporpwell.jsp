      ...
      <div class="modal-dialog modal-lg" >
        <div class="modal-content" >
        	<div class="modal-header">
              ...
              <h4 class="modal-title" id="etitle">降水井导入</h4>
            </div>
										...
										<div class="alert alert-block alert-danger fade in">
                                          ...
                                          <div class="form-group clearfix" >
                                              ...
                                              <div class="col-lg-4">
                                               ...
                                               <label class="col-lg-2 control-label control-required" >流量阈值</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select required"></select>
                                              </div>
                                          </div>
                                          <div class="form-group clearfix" >
                                              <label class="col-lg-2 control-label control-required" >水位阈值上限</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select required"></select>
                                              </div>
                                               <label class="col-lg-2 control-label control-required" >水位阈值下限</label>
                                              <div class="col-lg-4">
                                                  <select class="form-control select required"></select>
                                              </div>
                                          </div>
                                          <div class="form-group clearfix" >
                                              <label class="col-lg-2 control-label " >状态(0:开启 1：关闭 默认为0)</label>
                                              <div class="col-lg-4">
