				...
				.dataTable(
						{
							...
							"aoColumnDefs" : [
									...
									{	
										"aTargets" : [1],
										"mRender" : function(data, type, full) {
											return '<a class="tooltips" data-placement="left" data-original-title="详情" href="'+_context+'/water/monitor/detail.html?mid='+full.id+'" >'+data+'</a>';
										},
										"bSortable" : false
									},
									{
										...
										"mRender" : function(data, type, full) {
											 ...
											 if(full.sstatus==1){
												 var s = '<a class="edit btn btn-primary btn-xs tooltips hasfn" data-placement="left" data-original-title="编辑" href="javascript:;" ><i class="fa fa-pencil"></i></a>';
													s += '&nbsp;<a href="javascript:;" id="del_btn" class="btn btn-danger btn-xs tooltips" data-placement="left" data-original-title="删除" onclick="deldata('
															+ data
