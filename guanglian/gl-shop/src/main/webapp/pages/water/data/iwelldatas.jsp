                      ...
                      <div class="panel-body">
                      	<form:form cssClass="form-horizontal" role="form" commandName="pData" id="storeform">
							...
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label ">井内水位</label>
								<div class="col-lg-10">
									<form:input cssClass="form-control "  type="number" path="pressure" id="pressure" />
						...
						<form:hidden path="iWell.id" id="iWell.id" />
						</form:form>
                  </div>
                  </section>				
</div>
...
function goback(){
	...
	function jssubmit(){
		if($("#pressure").val()=="" && $("#flow").val()=="" ){
			toastr.error('井内水位或者流量必须有一个值输入！！！');
			return;
		}
		 $("#storeform").submit();
	}
