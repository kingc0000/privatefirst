				...
				<section class="panel" >
                      ...
                      <div class="panel-body">
                      	<form:form cssClass="form-horizontal" role="form" commandName="pData" id="storeform">
							...
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label ">水温</label>
								<div class="col-lg-10">
									<form:input cssClass="form-control "  type="number" path="temperature" id="temperature" />
                                       <span class="help-block"> <form:errors path="temperature" cssClass="error" /></span>
                               </div> 
							</div>
							<div class="form-group">
						...
						<form:hidden path="oWell.id" id="oWell.id" />
						</form:form>
                  </div>
                  </section>				
</div>
...
function goback(){
	...
	function jssubmit(){
		if($("#water").val()=="" && $("#temperature").val()=="" ){
			toastr.error('水位或者水温必须有一个值输入！！！');
			return;
		}
		 $("#storeform").submit();
	}
