...
<div class="cmarquee">
	<div class="marquee-sibling" style="top:7px;">
		...
		<button  class="btn btn-img btn-selected tooltips pmaptool " data-placement="top" data-container="body" data-original-title="全部项目" onclick="showAll()"><i class="fa fa-globe"></i></button>
		<span style="display:none;" class="chartBtn">
			...
			<button  class="btn btn-img btn-selected tooltips maptools" data-placement="top" data-container="body" data-original-title="我的评论" onclick="toPreview()"><i class="fa fa-comment"></i></button>
			...
			<c:if test="${hasRight}">
				<button  class="btn btn-img btn-selected tooltips maptools" data-placement="top" data-container="body" data-original-title="施工日志" onclick="editDaily()"><i class="fa fa-pencil-square-o"></i></button>
			</c:if>
