                        ...
                        {"aTargets":[7],"mRender":function(data,type,full){
							...
							default:
                             ...
                             {"aTargets":[11],"mRender":function(data,type,full){
                            	 var reStr='<a class="btn btn-info btn-xs tooltips" data-placement="left" data-container="body" data-original-title="数据列表" href="'+_context+'/jiangong/idata/list.html?pid='+full.id+'" ><i class="fa fa-list"></i></a>&nbsp;';
