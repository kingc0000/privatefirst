...
<link href='<c:url value="/resources/data-tables/DT_bootstrap.css" />' rel="styleshee">
		...
		<section class="panel">
			...
			<div class="panel-body">
				<form:form cssClass="form-horizontal" role="form"
					commandName="xmreport" id="storeform">
...
<script>
$('#pictitle').html("${mentity.name }测斜日报");
var mid = '${mid}';
	$(function() {
$('#slist').dataTable({
							...
							"aoColumnDefs" : [
{
									...
									},
									{
										...
										"mRender" : function(data, type, full) {
											...
											s+='&nbsp;<a class="btn btn-info btn-xs tooltips hidden-xs" data-placement="left" data-container="body" data-original-title="下载" href="<c:url value="/water/xmreport/downloads/'+data+'.html?mid='+mid+'"/>" ><i class="fa fa-download"></i></a>&nbsp;';		
											return s;
										},
										"sWidth" : "120px",
										"bSortable" : false
