		...
		<section class="panel">
			...
			<div class="panel-body">
				<form:form cssClass="form-horizontal" role="form"
					commandName="greport" id="storeform">
							...
							"aoColumnDefs" : [
{
									...
									},
									{
										...
										"mRender" : function(data, type, full) {
											...
											s+='&nbsp;<a class="btn btn-info btn-xs tooltips hidden-xs" data-placement="left" data-container="body" data-original-title="下载" href="<c:url value="/water/greport/downloads/'+data+'.html?gid='+gid+'"/>" ><i class="fa fa-download"></i></a>&nbsp;';
											return s;
										},
										"sWidth" : "120px",
										"bSortable" : false
