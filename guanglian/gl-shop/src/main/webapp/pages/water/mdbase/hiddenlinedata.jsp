		...
		<section class="panel">
			...
			<div class="panel-body">
				<form:form cssClass="form-horizontal" role="form"
					commandName="hiddenlinedata" id="storeform">				
...
<div class="form-group">
	<label class="col-lg-2 col-sm-2 control-label control-required">上次水位</label>
	<div class="col-lg-10">
...
<div class="form-group">
	<label class="col-lg-2 col-sm-2 control-label control-required">本次水位</label>
	<div class="col-lg-10">
...
<script>
$('#pictitle').html("${mentity.name }潜层水位信息");
	var sid = '${sid}';
	var sum = 0;
	var flag = false;
	$(function() {
				...
				.dataTable(
						{
							...
							"aoColumnDefs" : [
									...
									},
									{
										"aTargets" : [ 4 ],
										"mRender" : function(data, type, full) {
											var s = (full.curtHeight-data)*1000;
											return s;
										}
									},
									{
		...
		$("input[name='curtHeight']").on("keyup", function(event) {
			var sch = (Number($("input[name='curtHeight']").val()) - Number($("input[name='initHeight']").val()))*1000;
			$("#vDisplacement").val(sch);
			var initheight = '${initHeight}';
			var sum = ((Number($("input[name='curtHeight']").val())-initheight))*1000;
