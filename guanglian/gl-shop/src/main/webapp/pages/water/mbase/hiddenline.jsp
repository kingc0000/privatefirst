		...
		<section class="panel">
			...
			<div class="panel-body">
				<form:form cssClass="form-horizontal" role="form"
					commandName="hiddenline" id="storeform">
					<jsp:include page="/common/mBase.jsp"></jsp:include>
					<div class="form-group">
						<label class="col-lg-2 col-sm-2 control-label control-required">初始水位</label>
						<div class="col-lg-10">
				...
				.dataTable(
						{
							...
							"aoColumnDefs" : [
									...
									},
									{
										"aTargets" : [ 5 ],
										"mRender" : function(data, type, full) {
											var s='<a class="btn btn-info btn-xs tooltips" data-placement="left" data-container="body" data-original-title="数据列表" href="'+_context+'/water/hiddenlinedata/list.html?sid='+full.id+'&mid='+mid+'" ><i class="fa fa-list"></i></a>&nbsp;';
