...
<div class="container" >
    ...
    <!-- Cropping modal -->
    <div class="modal fade" id="export-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
              ...
              <form action="exportCols.shtml" id="export-form" class="form-horizontal" method="POST">
              	...
              	<br>
                  	...
                  	<div class="col-md-6 col-xl-12">
	              		<div class="row">
	              			<label class="col-lg-3 col-sm-3 control-label control-required">开始</label>
	              		<div class="input-group date edate col-lg-9 col-sm-9" >
										<input type="text" class="form-control" id="ebegindt" name="ebegindt"/><span class="input-group-addon btn-theme"><i class="fa fa-calendar"></i></span>
									</div>
	              		</div>
	              	</div>
              	  	<div class="col-md-6 col-xl-12 ">
	              		<div class="row">
	              			<label class="col-lg-3 col-sm-3 control-label control-required">结束</label>
	              		<div class="input-group date edate col-lg-9 col-sm-9" >
										<input type="text" class="form-control" id="eendtm" name="eendtm"/><span class="input-group-addon btn-theme"><i class="fa fa-calendar"></i></span>
									</div>
	              		</div>
	              	</div>
	              	<br>
              	...
              	<div class="form-group">
					...
					<div class="col-lg-10">
						<button type="button" onclick="exportexcel()" class="btn btn-success pull-right">导出</button>
					</div>
				</div>
				<br/>
...
<script type="text/javascript">
	...
	function exportexcel(){
		...
		var begindt = $("input[name='ebegindt']").val();
		 var endtm = $("input[name='eendtm']").val();
		 if (begindt=='' || endtm=='') {
