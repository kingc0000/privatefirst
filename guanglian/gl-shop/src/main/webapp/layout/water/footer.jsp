...
<div class="navbar-fixed-bottom visible-xs footerb"
	...
	<ul class="footerli">
		<li><a class="needsclick" href='<c:url value="/"/>'><i class=" fa fa-home"></i>首页</a></li>
		<li><a class="needsclick" href='<c:url value="/water/users/displayUser.html"/>'><i
				class=" fa fa-user"></i>基本信息</a></li>
		<li><a  class="needsclick" href='<c:url value="/water/users/password.html"/>'><i
				class="fa fa-chain"></i>修改密码</a></li>
