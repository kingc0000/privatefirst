...
<body>
	...
	<section id="container" class="full-width">
		...
		<header class="header white-bg text-center">
			<button type="button" class="navbar-toggle" data-toggle="collapse" id="camera-fa-bars" data-target=".navbar-collapse">
                  <span class="fa fa-bars"></span>
              </button>
			<!--logo start-->
			<a href='<c:url value="/water/home.html"/>' class="logo"><i class="theme-color fa fa-chevron-left"></i>&nbsp;&nbsp;</a>
		...
		<!--main content end-->
		<jsp:include page="/layout/water/cameralfooter.jsp" />
	</section>
<!-- Material button -->
