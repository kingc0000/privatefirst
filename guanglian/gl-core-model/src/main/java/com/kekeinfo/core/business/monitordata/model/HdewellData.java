...
@Table(name = "HDEWELLDATA", schema=SchemaConstant.KEKEINFO_SCHEMA)
public class HdewellData extends KekeinfoEntity<Long, HdewellData> implements Auditable {
	...
	@Id
	@Column(name = "HDEWELLDATA_ID", nullable=false)
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "HDEWELLDATA_SEQ_NEXT_VAL")
