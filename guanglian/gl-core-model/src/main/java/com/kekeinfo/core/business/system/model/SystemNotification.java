...
@Table(name = "SYSTEM_NOTIFICATION", schema= SchemaConstant.KEKEINFO_SCHEMA )
public class SystemNotification extends KekeinfoEntity<Long, SystemNotification> implements Serializable, Auditable {
