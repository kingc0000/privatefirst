...
@Table(name = "IWELLDATA", schema=SchemaConstant.KEKEINFO_SCHEMA)
public class IwellData extends KekeinfoEntity<Long, IwellData> implements Auditable {
	...
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "IWELLDATA_SEQ_NEXT_VAL")
