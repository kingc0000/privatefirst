...
@Table(name = "PUMPWELLMARKER", schema = SchemaConstant.KEKEINFO_SCHEMA)
public class PumpWellMarker extends KekeinfoEntity<Long, PumpWellMarker> {
    ...
    @JoinColumn(name = "PUMPWELL_ID")
    private Pumpwell well;
    ...
    public Pumpwell getWell() {
        return well;
    }

    public void setWell(Pumpwell well) {
        this.well = well;
    }
}
