...
@Table(name = "IMGDEWARTWELL", schema = SchemaConstant.KEKEINFO_SCHEMA)
public class ImgDewartWell extends KekeinfoEntity<Long, ImgDewartWell> {

    private static final long serialVersionUID = 1695826342009139776L;

    @Id
    @Column(name = "DEWARTWELL_ID", nullable = false)
    @TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName =
            "SEQ_COUNT", pkColumnValue = "DEWARTWELL_SEQ_NEXT_VAL")
