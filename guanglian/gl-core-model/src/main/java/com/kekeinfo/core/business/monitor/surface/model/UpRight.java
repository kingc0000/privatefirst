...
@Table(name = "MUPRIGHT", schema = SchemaConstant.KEKEINFO_SCHEMA)
public class UpRight extends MbasePoint<UpRight> implements Auditable {
	/**
	 * 立柱变形
	 */
	private static final long serialVersionUID = -8231506062099735443L;
	@Id
	@Column(name = "UPRIGHT_ID", unique = true, nullable = false)
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "MUPRIGHT_SEQ_NEXT_VAL")
