 ...
 */
public abstract class KekeinfoEntity<K extends Serializable & Comparable<K>, E extends KekeinfoEntity<K, ?>>
		implements Serializable, Comparable<E> {

	private static final long serialVersionUID = -3988499137919577054L;
	
	public static final Collator DEFAULT_STRING_COLLATOR = Collator.getInstance(Locale.CHINESE);
	...
	public boolean equals(Object object) {
		...
		KekeinfoEntity<K, E> entity = (KekeinfoEntity<K, E>) object; // NOSONAR : traité au-dessus mais wrapper Hibernate 
		K id = getId();
