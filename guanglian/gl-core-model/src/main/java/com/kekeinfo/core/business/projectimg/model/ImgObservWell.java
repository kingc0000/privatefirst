...
@Table(name = "IMGOBSERVWELL", schema = SchemaConstant.KEKEINFO_SCHEMA)
public class ImgObservWell extends KekeinfoEntity<Long, ImgObservWell> {

    private static final long serialVersionUID = -51202408824924031L;

    @Id
    @Column(name = "OBSERVWELL_ID", nullable = false)
    @TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName =
            "SEQ_COUNT", pkColumnValue = "OBSERVWELL_SEQ_NEXT_VAL")
