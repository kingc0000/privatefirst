...
@Table(name = "HEMONITORDATA", schema=SchemaConstant.KEKEINFO_SCHEMA)
public class HemonitorData extends KekeinfoEntity<Long, HemonitorData> implements Auditable {
	...
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "HEMONITORDATA_SEQ_NEXT_VAL")
