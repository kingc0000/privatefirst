package com.kekeinfo.core.business.system.model;
...
@Table(name = "SYSTEM_CONFIGURATION", schema= SchemaConstant.KEKEINFO_SCHEMA)
public class SystemConfiguration extends KekeinfoEntity<Long, SystemConfiguration> implements Serializable, Auditable {
