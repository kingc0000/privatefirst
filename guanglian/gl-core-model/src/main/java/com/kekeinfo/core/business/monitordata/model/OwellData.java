...
@Table(name = "OWELLDATA", schema=SchemaConstant.KEKEINFO_SCHEMA)
public class OwellData extends KekeinfoEntity<Long, OwellData> implements Auditable {
	...
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "OWELLDATA_SEQ_NEXT_VAL")
