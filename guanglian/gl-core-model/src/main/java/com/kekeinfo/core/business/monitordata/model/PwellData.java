...
@Table(name = "PWELLDATA", schema=SchemaConstant.KEKEINFO_SCHEMA)
public class PwellData extends KekeinfoEntity<Long, PwellData> implements Auditable {
	...
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "PWELLDATA_SEQ_NEXT_VAL")
