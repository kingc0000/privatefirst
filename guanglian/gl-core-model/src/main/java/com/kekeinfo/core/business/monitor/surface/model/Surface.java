...
@Table(name = "MSURFACE", schema=SchemaConstant.KEKEINFO_SCHEMA)
public class Surface extends  MbasePoint<Surface> implements Auditable{
	/**
	 * 周边地表
	 */
	...
	pkColumnValue = "MSURFACE_SEQ_NEXT_VAL")
