package com.kekeinfo.core.business.gonproblem.model;
...
@Table(name = "GUARDPROBLEM", schema = SchemaConstant.KEKEINFO_SCHEMA)
public class GonProblem extends KekeinfoEntity<Long, GonProblem> implements Auditable{
	...
	@Id
	@Column(name = "GON_ID", unique = true, nullable = false)
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "GONPRO_SEQ_NEXT_VAL")
	...
	@JoinTable(name = "GONPRO_ATTACH", schema = SchemaConstant.KEKEINFO_SCHEMA, joinColumns = {
			@JoinColumn(name = "GON_ID", nullable = false, updatable = false) }, inverseJoinColumns = {
