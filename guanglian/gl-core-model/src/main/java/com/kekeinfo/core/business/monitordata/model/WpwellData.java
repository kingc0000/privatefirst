...
@Table(name = "WARNING_PWELLDATA", schema=SchemaConstant.KEKEINFO_SCHEMA)
public class WpwellData extends WarningData<Pumpwell> implements Auditable {


	/**
	 * 
	 */
	private static final long serialVersionUID = -1193914855232320082L;

	@Id
	@Column(name = "WARNING_ID", nullable=false)
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "WPWELLDATA_SEQ_NEXT_VAL")
