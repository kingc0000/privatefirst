...
@Entity
@Table(name = "P_DEWATERINGLINK", schema=SchemaConstant.KEKEINFO_SCHEMA,
...
public class DewateringLink extends BasepointLink<Dewatering> {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3889985442409169182L;
	@Id
	@Column(name = "P_DEWATERINGLINK_ID", nullable=false)
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "P_DEWATERINGLINK_SEQ_NEXT_VAL")
