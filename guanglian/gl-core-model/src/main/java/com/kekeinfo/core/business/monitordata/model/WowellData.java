...
@Table(name = "WARNING_OWELLDATA", schema=SchemaConstant.KEKEINFO_SCHEMA)
public class WowellData extends WarningData<Observewell> implements Auditable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 683392756674578242L;

	@Id
	@Column(name = "WARNING_ID", nullable=false)
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "WOWELLDATA_SEQ_NEXT_VAL")
