...
<div class="container">
	...
	<div class="email-content">
		<h3>${LABEL_HI} ${EMAIL_CUSTOMER_FIRSTNAME}</h3>
		<!--order number-->
		<div class="text-center margin-bot">
			<h3>${EMAIL_ORDER_NUMBER} &nbsp;&nbsp;&nbsp;&nbsp;${EMAIL_ORDER_DATE}</h3>
		</div>
		<!--order detail -->
		...
		<!--order address info -->
		<div>
				<h4>${ADDRESS_BILLING_TITLE} &raquo;</h4>
				<p>
					${ADDRESS_BILLING}
				</p>
		</div>
		<!--order delivery info -->
		<div>
				<h4>${ADDRESS_DELIVERY_TITLE} &raquo;</h4>
				<p>
					${ADDRESS_DELIVERY}
				</p>
		</div>
