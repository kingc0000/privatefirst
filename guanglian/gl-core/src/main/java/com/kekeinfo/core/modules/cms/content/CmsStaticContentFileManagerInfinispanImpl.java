...
import com.kekeinfo.core.modules.cms.impl.CacheManager;
...
public class CmsStaticContentFileManagerInfinispanImpl implements FilePut,FileGet,FileRemove
{
        ...
        throws ServiceException
    {
        ...
        try
        {
    		...
    		String nodePath = this.getNodePath(inputStaticContentData.getFileContentType());
     ...
     */
    @Override
    public OutputContentFile getFile( final FileContentType fileContentType, final String contentFileName )
        throws ServiceException
    {
        ...
        try
        {
    		...
    		String nodePath = this.getNodePath(fileContentType);
        ...
        {
            LOGGER.error( "Error while fetching file for {}  ", e);
            throw new ServiceException( e );
        }
	...
	@Override
	public List<OutputContentFile> getFiles(final FileContentType staticContentType) throws ServiceException {
        ...
        try
        {
    		...
    		String nodePath = this.getNodePath(staticContentType);
        ...
        throws ServiceException
    {
        ...
        LOGGER.info( "Removing all images for {}  ");
        if ( cacheManager.getTreeCache() == null )
        {
            LOGGER.error( "Unable to find cacheManager.getTreeCache() in Infinispan.." );
        ...
        try
        {
			...
			cacheManager.getTreeCache().getRoot().remove(Constants.DEFAULTSTORE, flag);
        ...
        {
            LOGGER.error( "Error while deleting content image for all");
            throw new ServiceException( e );
        }
    ...
    private String getNodePath(final FileContentType contentType) {
    	
		StringBuilder nodePath = new StringBuilder();
		nodePath.append(Constants.DEFAULTSTORE).append("/").append(contentType.name());
     ...
     */
	@Override
	public List<String> getFileNames(final FileContentType staticContentType)
			throws ServiceException {
	       ...
	       if ( cacheManager.getTreeCache() == null )
	        ...
	        {
	            LOGGER.error( "Error while fetching file for {} all ");
	            throw new ServiceException( e );
	        }
