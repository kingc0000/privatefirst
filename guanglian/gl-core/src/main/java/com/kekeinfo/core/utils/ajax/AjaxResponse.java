package com.kekeinfo.core.utils.ajax;
...
public class AjaxResponse implements JSONAware {
	...
	public final static int RESPONSE_STATUS_EXIST=-3; //已存在
	public final static int RESPONSE_STATUS_FAIURE_MESSAGE=-4; //返回报错，并且前台页面显示后台的报错信息
	public final static int RESPONSE_OPERATION_COMPLETED=9999;
	public final static int CODE_ALREADY_EXIST=9998;
	public final static int RESPONSE_STATUS_SUCCESSANDEXTERN=11; //返回前台，允许根据不同的值，进行不同的操作
	
	private int status = RESPONSE_STATUS_SUCCESS;
