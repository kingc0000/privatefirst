...
public class StreamTransport implements Transport, Runnable {
	private final static Log LOG = LogFactory.getLog(StreamTransport.class);
    ...
    public StreamTransport(InputStream in, OutputStream out) {
        this.out = out;
        this.in = in;
//        LOG.debug("out.code="+out.hashCode());
    }
...
//		System.out.println("服务端返回到客户端的信息:" + StreamUtils.dumpHex(b));
    }
