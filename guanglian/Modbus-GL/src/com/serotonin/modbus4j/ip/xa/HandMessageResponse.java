...
public class HandMessageResponse extends XaMessage implements IpMessageResponse {
    static HandMessageResponse createXaMessageResponse(ByteQueue queue) throws ModbusTransportException {
        ...
        return new HandMessageResponse(response, transactionId);
//        ModbusResponse response = HandResponse.createModbusResponse(queue);
//        return new HandMessageResponse(response, transactionId);
    }

    public HandMessageResponse(ModbusResponse modbusResponse, int transactionId) {
